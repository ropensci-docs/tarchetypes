...
`tar_group_select()` expects you to select grouping variables using
`tidyselect` semantics. Downstream dynamic branching targets will
iterate over the groups of rows.
...
- by:
  ...
  Tidyselect semantics to specify variables to group over.

...
Create a target that outputs a grouped data frame for downstream dynamic
branching. Row groups have the number of rows you supply to `size` (plus
the remainder in a group of its own, if applicable.) The total number of
groups varies.
